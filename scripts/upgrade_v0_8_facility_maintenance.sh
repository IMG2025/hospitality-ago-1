...
// --- YAML readers (checks.yaml, loss_prevention.yaml, maintenance.yaml) ---
type Rule =
...
function lossEngine(findings: Finding[], cache: Record<string, { headers: string[]; rows: Record<string, string>[] }>, lossPolicy: LossPolicy) {
...
function maintenanceEngine(findings: Finding[], cache: Record<string, { headers: string[]; rows: Record<string, string>[] }>, mp: MaintPolicy) {
